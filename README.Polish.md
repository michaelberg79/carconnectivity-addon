![Obsługuje architekturę aarch64][aarch64-shield]
...
[aarch64-shield]: https://img.shields.io/badge/aarch64-tak-zielony.svg
[amd64-shield]: https://img.shields.io/badge/amd64-tak-zielony.svg
[armhf-shield]: https://img.shields.io/badge/armhf-tak-zielony.svg
[armv7-shield]: https://img.shields.io/badge/armv7-tak-zielony.svg
[i386-shield]: https://img.shields.io/badge/i386-tak-zielony.svg

# Dodatek do Home Assistant: CarConnectivity

|         | Stabilny                                                                                                                       | Krawędź                                                                                                                                   |
| ------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Wersja  | [![Wydanie GitHub (najnowsze według daty)](https://img.shields.io/docker/v/pulpyyyy/carconnectivity-addon-amd64?&sort=date&label=&style=for-the-badge)](https://github.com/pulpyyyy/carconnectivity-addon/releases) | [![Wersja obrazu Docker (najnowsza semver)](https://img.shields.io/docker/v/pulpyyyy/carconnectivity-addon-edge-amd64?&sort=date&label=&style=for-the-badge)](https://github.com/Pulpyyyy/carconnectivity-addon/blob/main/carconnectivity-addon-edge/CHANGELOG.md) |
